...
let lovelvl = 5;
let happinesslvl = 5;
const opportunity = ["opportunity","opportunity","opportunity","education","education","wealth","wealth","Tax! pay $200"]
...
const wealthselection = [
    ...
    "10k-20k to rent out up to 2 sports car. $300 per Car a paycheck. ",
    "15k-30k rent out up to 2 houses in Florida. $300 per house a paycheck.",
    "15k to rent out a mansion in Minnesota. $500 a paycheck.",
    "20k to rent out an apartment in NewYork. $700 a paycheck.",
    "30k to rent out a studio in the Bahamas. $1,000 a paycheck."
];
...
function dice() {
    ...
    if (opportunity[opportunityrolled]== "Tax! pay $200"){
        document.getElementById('activity').value="Pay $200"; 
    }
